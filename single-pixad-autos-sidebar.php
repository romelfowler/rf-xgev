...
<div class="col-md-4">
	...
	<?php if ($pix_show_specifications) : ?>
		<section class="widget">
			<h3 class="widget-title"><?php  esc_html_e( 'XGEV Options', 'autozone' ) ?></h3>
      <!-- Line decore -->
	...
	<?php if ($has_video) : ?>
		<section class="widget widget-banner">
			<h3 class="widget-title"><?php esc_html_e( 'Vehicle Video', 'autozone' ); ?></h3>
			<div class="decor-1"></div>
			<div class="widget-content">
    ...
    <?php if ($pix_show_related) : ?>
		<section class="widget">
			<h3 class="widget-title"><?php esc_html_e( 'Related Vehicles', 'autozone') ?></h3>
			<div class="decor-1"></div>
			<?php
