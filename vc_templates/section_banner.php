...
$decor = isset($use_decor) && $use_decor == true ? '<div class="decor-2"><i class="icon fa fa-caret-down"></i></div>' : '<img class="decor-america" src="/wp-content/themes/autozone/images/america170x280.png"
>';
